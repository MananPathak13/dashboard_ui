...
const Navbar = async () => {
    ...
    return (
        <div className='flex items-center justify-between p-4'>
            {/* SEARCH BAR */}
            <div className='hidden md:flex items-center gap-2 text-s rounded-full ring-[1.5px] ring-gray-300 px-2'>
                <Image src="/search.png" alt='sreach_logo' width={14} height={14} />
            ...
            <div className=' flex items-center gap-6 w-full justify-end'>
                ...
                <div className='bg-white rounded-full w-7 h-7 flex items-center justify-center cursor-pointer relative'>
                    <Image src="/announcement.png" alt='message logo' width={20} height={20} />
